<div>
    <form id="form-search" class="col-md-11 mt-2" action="{{ route('search') }}" method="">
        @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 pb-2">
                            <label class="text-white">
                                ...
                                <span>{{__('Số người')}}</span><span class="text-warning" style="font-size: 11px"> *{{__('Mỗi người lớn tối đa đi cùng 2 trẻ em ')}}</span>
                            </label>
                            <div class="d-flex justify-content-center">
                                <div class=" col-md-6 input-with-icon">
                                    <i class="fa-solid fa-person"></i>
                                    <input type="number" name="adults"
                                           class="w-100 find-input border-right-0 rounded-left" placeholder="{{__('Người lớn')}}"
                                ...
                                <div class=" col-md-6 input-with-icon">
                                    ...
                                    <input type="number" name="children" min="0" max="{{ $maxChildren }}"
                                           class="w-100 find-input border-left-0 rounded-right" placeholder="{{__('Trẻ em')}}"
