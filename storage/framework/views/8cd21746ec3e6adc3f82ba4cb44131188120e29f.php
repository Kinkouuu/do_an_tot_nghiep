<div class="pl-2">
   ...
   <?php if($checkin_at && !$checkout_at): ?>
    ...
    <p class="text-capitalize m-0"><?php echo e($checkout_at); ?></p>
    <p class="m-0">(<?php echo e($lately); ?> so với giờ checkout)</p>
    <?php else: ?>
        <a type="button" class="text-primary pl-2" style="text-decoration: underline" data-toggle="modal" data-target="#respective-room-<?php echo e($room['id']); ?>">
