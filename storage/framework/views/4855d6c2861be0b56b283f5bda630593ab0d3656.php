<?php $__env->startSection('content'); ?>
    ...
    <form class="container col-md-6 text-center justify-content-center"
          action="<?php echo e(route('admin.devices.update', $device)); ?>" method="POST">
            ...
            <select class="selectpicker w-75" name="type_device_id" data-live-search="true"
                ...
                <?php $__currentLoopData = $typeDevices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $typeDevice): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option data-icon="<?php echo e($typeDevice->icon); ?>"
                            <?php echo e($device->type_device_id == $typeDevice->id ? 'selected' : ''); ?> value=<?php echo e($typeDevice->id); ?>>
...
unset($__errorArgs, $__bag); ?>
        <div class="w-100 input-group input-group-sm mb-3">
            ...
            <input type="text" class="form-control w-75" aria-label="Sizing example input"
                   aria-describedby="inputGroup-sizing-sm" name="name" value="<?php echo e($device->name); ?>">
        </div>
...
unset($__errorArgs, $__bag); ?>
        <div class="w-100 input-group input-group-sm mb-3">
            ...
            <input type="number" class="form-control w-auto " aria-label="Sizing example input"
                   ...
                   value="<?php echo e($device->rental_price); ?>">
...
unset($__errorArgs, $__bag); ?>
        <div class="w-100 input-group input-group-sm mb-3">
            ...
            <input type="number" class="form-control w-auto " aria-label="Sizing example input"
                   aria-describedby="inputGroup-sizing-sm" name="quantity" min="0" value="<?php echo e($device->quantity); ?>">
            ...
            <div class="w-75 m-auto d-flex justify-content-around">
                <div class="form-check">
                    <input class="form-check-input" type="radio" name="for_rent" id="exampleRadios1"
                           value="0" <?php echo e(!$device->for_rent ? 'checked' : ''); ?>>
                ...
                <div class="form-check">
                    <input class="form-check-input" type="radio" name="for_rent" id="exampleRadios2"
                           value="1" <?php echo e($device->for_rent ? 'checked' : ''); ?>>
...
<?php echo $__env->make('admin.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\DATN\VVCBooking\resources\views/admin/pages/devices/edit.blade.php ENDPATH**/ ?>