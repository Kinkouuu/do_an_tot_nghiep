...
} elseif ($_instance->childHasBeenRendered('fZ5vwWm')) {
    $componentId = $_instance->getRenderedChildComponentId('fZ5vwWm');
    $componentTag = $_instance->getRenderedChildComponentTagName('fZ5vwWm');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('fZ5vwWm');
} else {
    $response = \Livewire\Livewire::mount('verify.re-send-code', []);
    $html = $response->html();
    $_instance->logRenderedChild('fZ5vwWm', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
