<?php $__env->startSection('content'); ?>
    ...
    <form class="container col-md-6 text-center justify-content-center"
          action="<?php echo e(route('admin.services.update', $service)); ?>" method="POST">
...
unset($__errorArgs, $__bag); ?>
        <div class="w-100 input-group input-group-sm mb-3">
            ...
            <input type="text" class="form-control w-75" aria-label="Sizing example input"
                   aria-describedby="inputGroup-sizing-sm" name="name" value="<?php echo e($service->name); ?>">
        </div>
...
unset($__errorArgs, $__bag); ?>
        <div class="w-100 input-group input-group-sm mb-3">
            ...
            <textarea class="ckeditor" placeholder="Mô tả chi tiết"
                      name="description" id="description" maxlength="300" style="min-height: 150px"><?php echo e($service->description); ?></textarea>
        </div>
...
unset($__errorArgs, $__bag); ?>
        <div class="w-100 input-group input-group-sm mb-3">
            ...
            <input type="number" class="form-control w-auto " aria-label="Sizing example input"
                   aria-describedby="inputGroup-sizing-sm" name="price" min="0" value="<?php echo e($service->price); ?>">
        ...
        <div class="w-100 input-group input-group-sm mb-3">
            ...
            <select class="form-select" name="status">
                <?php $__currentLoopData = \App\Enums\Service\ServiceStatus::asArray(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $status): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option <?php echo e($service->status == $status ? 'selected' : ''); ?> value="<?php echo e($status); ?>">
                        <?php echo e($status == \App\Enums\Service\ServiceStatus::Active ? 'Đang cung cấp' : 'Dừng cung cấp'); ?>
...
<?php echo $__env->make('admin.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\DATN\VVCBooking\resources\views/admin/pages/services/edit.blade.php ENDPATH**/ ?>