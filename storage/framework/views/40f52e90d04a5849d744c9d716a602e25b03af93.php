...
<?php $__env->startSection('content'); ?>
                    ...
                    <div class="col-md-6 col-lg-4 mb-5">
                        <div class="hotel-room text-center">
                            <a href="#" class="d-block mb-0 thumbnail">
                                <img src="<?php echo e(asset($room_type['thumb_nail'])); ?>" alt="Image" class="img-fluid">
                            </a>
                            <div class="hotel-room-body">
                                <h3 class="heading mb-0"><a href="#"><?php echo e($room_type['name']); ?></a></h3>
                                <strong class="price">
                                    <?php echo e(number_format($room_type['prices'][PriceType::ListedDayPrice['value']]['price'], 0, ',', '.')); ?> VND /
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-md-6 mb-5 mb-md-0">
                  ...
                  <span class="icon-wrap">
                    <span class="icon icon-play"></span>
                            ...
                            <img src="<?php echo e(asset('images/img_2.jpg')); ?>" alt="" class="img-fluid">
                        </a>
                    </div>

                    <img src="<?php echo e(asset('images/img_1.jpg')); ?>" href="<?php echo e(asset('images/img_1.jpg')); ?>" alt="Image" class="img-fluid image-absolute image-popup img-opacity">
                ...
                <div class="col-md-5 ml-auto">
                    ...
                    <p class="mb-4">Khách sạn Hoàng Hôn luôn mang vẻ đẹp hiện đại xen lẫn nét cổ kính. Đặt khách sạn sớm nhất để hưởng trọn ưu đãi, hãy tận hưởng một kì nghỉ tuyệt vời cùng gia đình, bạn bè ...</p>
    ...
    <div class="site-section">
        <div class="container">
            <div class="row">
                <div class="col-md-6 mx-auto text-center mb-5 section-heading">
                    <h2 class="mb-5">Dịch vụ nổi bật</h2>
                </div>
            </div>
            <div class="row">
                <div class="col-sm-6 col-md-4 col-lg-3">
                    <div class="text-center p-4 item">
                        ...
                        <h2 class="h5">Chăm sóc sức khỏe</h2>
                    </div>
                </div>
                <div class="col-sm-6 col-md-4 col-lg-3">
                    <div class="text-center p-4 item">
                ...
                <div class="col-sm-6 col-md-4 col-lg-3">
                    <div class="text-center p-4 item">
                        ...
                        <h2 class="h5">Tổ chức sự kiện</h2>
                    </div>
                </div>
                ...
                <div class="col-sm-6 col-md-4 col-lg-3">
                    <div class="text-center p-4 item">
                        ...
                        <h2 class="h5">Dịch vụ trông trẻ</h2>
                    </div>
                </div>
                <div class="col-sm-6 col-md-4 col-lg-3">
                    <div class="text-center p-4 item">
                        <i class="fa-solid fa-plane-arrival display-3 mb-3 d-block text-primary"></i>
                        <h2 class="h5">Đưa đón sân bay</h2>
                    </div>
                </div>
                <div class="col-sm-6 col-md-4 col-lg-3">
                    <div class="text-center p-4 item">
                        <i class="fa-solid fa-car display-3 mb-3 d-block text-primary"></i>
                        <h2 class="h5">Thuê xe tự lái</h2>
                    </div>
                </div>
            </div>
        </div>
    </div>
    <div class="py-5 upcoming-events" style="background-image: url('<?php echo e(asset('images/hero_1.jpg')); ?>'); background-attachment: fixed;">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-md-6">
                    <h2 class="text-white">Ưu đãi hè</h2>
                    <h5 class="text-white">Tặng voucher 50% cho khách hàng đăng ký lần đầu.</h5>
                    <a href="<?php echo e(route('signup')); ?>" class="text-white btn btn-outline-warning rounded-0 text-uppercase">Đăng ký ngay</a>
                </div>
                <div class="col-md-6">
    ...
    <div class="site-section">
            <div class="row">
                <div class="col-md-6 mx-auto text-center mb-5 section-heading">
                    <h2 class="mb-5">Hè này đi đâu?</h2>
                </div>
            </div>
               <div class="col-md-10 m-auto">
                   <div class="row">
                       <?php $__currentLoopData = $branches; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$branch): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                           <div class="col-md-6 mx-auto p-3 border rounded" style=" background-image: linear-gradient(to right, lightpink, lightcyan); height: 250px">
                               <a href="" class="position-relative">
                                   <h3 class="branch-city text-bold text-uppercase"><?php echo e($branch->first()->city); ?></h3>
                                   <img src="<?php echo e(asset($branch->first()->avatar)); ?>" alt="Image" class="img-fluid w-100 h-100" >
                                   <div class="branch-count"><?php echo e(count($branch)); ?> chi nhánh
