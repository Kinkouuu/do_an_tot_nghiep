...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group d-md-flex pb-5">
                            <div class="w-50">
                                <a href="<?php echo e(route('forgot_password')); ?>" class="w-100 text-center">Quên mật khẩu</a>
                            </div>
                    ...
                    <div class="w-100 text-center">
                        <a href="<?php echo e(route('signup')); ?>" class="w-100 text-center">&mdash; Đăng ký tài khoản mới &mdash;</a>
                    </div >
                </div>
            </div>
        </div>
