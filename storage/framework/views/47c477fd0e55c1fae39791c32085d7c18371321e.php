    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-6 text-center mb-5">
                <h2 class="heading-section"><?php echo e(__('Đăng nhập')); ?></h2>
            </div>
        </div>
        <div class="row justify-content-center">
...
unset($__errorArgs, $__bag); ?>
                        <div class="form-group">
                            <input type="text" class="form-control" name="phone" placeholder="<?php echo e(__('Số điện thoại')); ?>">
                        </div>
...
unset($__errorArgs, $__bag); ?>
                        <div class="form-group">
                            <input id="password-field" type="password" name="password" class="form-control" placeholder="<?php echo e(__('Mật khẩu')); ?>">
                            <span toggle="#password-field" class="fa fa-fw fa-eye field-icon toggle-password"></span>
                        </div>
                        <div class="form-group">
                            <button type="submit" class="text-uppercase form-control btn btn-primary submit px-3"><?php echo e(__('Đăng nhập')); ?></button>
                        </div>
                        <div class="form-group d-md-flex pb-5">
                            <div class="w-50">
                                <a href="<?php echo e(route('forgot_password')); ?>" class="w-100 text-center"><?php echo e(__('Quên mật khẩu')); ?></a>
                            </div>
                            <div class="w-50 text-md-left">
                                <span style="color: #fff"><?php echo e(__('Bạn chưa có tài khoản')); ?>?</span>
                            </div>
                        </div>
                    </form>
                    <div class="w-100 text-center">
                        <a href="<?php echo e(route('signup')); ?>" class="w-100 text-center">&mdash; <?php echo e(__('Đăng ký tài khoản mới')); ?> &mdash;</a>
                    </div >
                </div>
            </div>
        </div>
...
<?php /**PATH E:\DATN\VVCBooking\resources\views/user/pages/authentication/login.blade.php ENDPATH**/ ?>