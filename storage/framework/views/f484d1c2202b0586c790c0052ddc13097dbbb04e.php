        ...
        <div class="row">
                        ...
                        <div class="col-md-12 mb-3 text-white"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3 row text-right">
                                    <a class="text-danger">
                                        <i class="btn fa-regular fa-heart fa-xl" style="color: #ff0000;"></i> <?php echo e(__('Yêu thích')); ?>

                                    </a>
                                    <a class="" style="color: #0c84ff">
                                        <i class="btn fa-solid fa-share-nodes fa-xl" style="color: #0c84ff"></i> <?php echo e(__('Chia sẻ')); ?>
            ...
            <div class="col-md-4 mt-4 mt-md-0">
                <div class="col-12 m-auto py-4 rounded text-white" style="background-color:#a6a6a6">
                    <h5 class="text-center text-light mb-3"> <?php echo e(__('Thông tin chuyến đi')); ?></h5>
                    <div class="col-md-12 mb-2">
                        <label>
                            <i class="fa-solid fa-location-dot"></i>
                            <span><?php echo e(__('Địa điểm')); ?>: <?php echo e(__('Khách sạn') . ' ' .$branch['name']); ?> - <?php echo e($branch['city']); ?></span>
                        </label>
                    </div>
                    <div class="col-md-12 mb-2">
                        <label>
                            <i class="fa-solid fa-restroom"></i>
                            <span> <?php echo e(__('Số người') . ': ' . $condition['adults'] . ' ' . __('người lớn') . ' & '
                    ...
                    <div class="col-md-12 mb-2">
                        <label>
                            ...
                            <span>
                                <?php echo e(__('Chuyến đi') . ' ' . $condition['duration'] . ' ' . __('cho')
...
unset($__errorArgs, $__bag); ?>
                                <div class="col-md-12 input-group mb-3">
                                    <div class="input-group-prepend col-md-5 p-0">
                                        <span class="input-group-text w-100"><?php echo e(__('Họ tên')); ?></span>
                                    </div>
...
unset($__errorArgs, $__bag); ?>
                                <div class="col-md-12 input-group mb-3">
                                    <div class="input-group-prepend col-md-5 p-0">
                                        <span class="input-group-text w-100"><?php echo e(__('Quốc tịch')); ?></span>
                                    </div>
...
unset($__errorArgs, $__bag); ?>
                                <div class="col-md-12 input-group mb-3">
                                    <div class="input-group-prepend col-md-5 p-0">
                                        <span class="input-group-text w-100"><?php echo e(__('CCCD')); ?>/Visa</span>
                                    </div>
                                ...
                                <div class="col-md-12 input-group mb-3">
                                    <div class="input-group-prepend col-md-5 p-0">
                                        <span class="input-group-text w-100"><?php echo e(__('Giới tính')); ?></span>
                                    </div>
                                    <select class="form-select" name="gender">
                                        <?php $__currentLoopData = UserGender::asArray(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $gender): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option
                                                ...
                                                <?php echo e($gender == UserGender::Male ? __('Nam') : __('Nữ')); ?>
                                ...
                                <div class="col-md-12 input-group mb-3">
                                    <div class="input-group-prepend col-md-5 p-0">
                                        <span class="input-group-text w-100"><?php echo e(__('Thanh toán bằng')); ?></span>
                                    </div>
...
unset($__errorArgs, $__bag); ?>
                                <div class="col-md-12 input-group mb-3">
                                    <div class="input-group-prepend col-md-5 p-0">
                                        <span class="input-group-text w-100"><?php echo e(__('Ghi chú')); ?></span>
                                    </div>
                        ...
                        <div class="col-md-12 text-center border-top py-4">
                            <div class="form-check mb-3">
                                ...
                                <label class="form-check-label text-left" for="confirm-btn" style="font-size: 12px">
                                    <?php echo e(__('Tôi cam đoan thông tin trên trùng khớp với thông tin định danh trên thẻ CCCD/Visa của người đại diện nhận phòng.')); ?>
