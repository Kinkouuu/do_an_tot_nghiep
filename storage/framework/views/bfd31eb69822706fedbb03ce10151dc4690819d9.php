...
} elseif ($_instance->childHasBeenRendered('uaV9aew')) {
    $componentId = $_instance->getRenderedChildComponentId('uaV9aew');
    $componentTag = $_instance->getRenderedChildComponentTagName('uaV9aew');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('uaV9aew');
} else {
    $response = \Livewire\Livewire::mount('status.change-status', ['item' => $staff]);
    $html = $response->html();
    $_instance->logRenderedChild('uaV9aew', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                </td>
