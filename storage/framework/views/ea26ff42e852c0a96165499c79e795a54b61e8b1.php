...
<?php $__env->startSection('content'); ?>
    ...
    <form class="container col-md-6 text-center justify-content-center"
          action="<?php echo e(route('admin.staffs.update', $staff)); ?>" method="POST">
...
unset($__errorArgs, $__bag); ?>
        <div class="w-100 input-group input-group-sm mb-3">
            ...
            <input type="text" class="form-control w-75" aria-label="Sizing example input"
                   aria-describedby="inputGroup-sizing-sm" name="account_name" value="<?php echo e($staff->account_name); ?>" disabled>
        </div>
        ...
        <div class="w-100 input-group input-group-sm mb-3">
            ...
            <select class="form-select" name="status">
                <?php $__currentLoopData = \App\Enums\UserStatus::asArray(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $status): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option <?php echo e($staff->status == $status ? 'selected' : ''); ?> value=<?php echo e($status); ?>>
        ...
        <div class="w-100 input-group input-group-sm mb-3">
            ...
            <select class="form-select" name="status">
                <?php $__currentLoopData = \App\Enums\RoleAccount::isStaff(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option <?php echo e($staff->role == $role ? 'selected' : ''); ?> value=<?php echo e($role); ?>>
...
unset($__errorArgs, $__bag); ?>
        <div class="w-100 input-group input-group-sm mb-3">
            ...
            <input type="text" class="form-control w-75" aria-label="Sizing example input"
                   aria-describedby="inputGroup-sizing-sm" name="name" value="<?php echo e($staff->name); ?>">
        </div>
...
unset($__errorArgs, $__bag); ?>
        <div class="w-100 input-group input-group-sm mb-3">
            ...
            <input type="text" class="form-control w-75" aria-label="Sizing example input"
                   aria-describedby="inputGroup-sizing-sm" name="email" value="<?php echo e($staff->email); ?>">
        </div>
...
unset($__errorArgs, $__bag); ?>
        <div class="w-100 input-group input-group-sm mb-3">
            ...
            <input type="text" class="form-control w-75" aria-label="Sizing example input"
                   aria-describedby="inputGroup-sizing-sm" name="phone" value="<?php echo e($staff->phone); ?>">
        </div>
...
unset($__errorArgs, $__bag); ?>
        <div class="w-100 input-group input-group-sm mb-3">
            ...
            <input type="text" class="form-control w-75" aria-label="Sizing example input"
                   aria-describedby="inputGroup-sizing-sm" name="address" value="<?php echo e($staff->address); ?>">
        </div>
...
unset($__errorArgs, $__bag); ?>
        <div class="w-100 input-group input-group-sm mb-3">
            ...
            <input type="text" class="form-control w-75" aria-label="Sizing example input"
                   aria-describedby="inputGroup-sizing-sm" name="citizen_id" value="<?php echo e($staff->citizen_id); ?>">
        </div>
...
unset($__errorArgs, $__bag); ?>
        <div class="w-100 input-group input-group-sm mb-3">
            ...
            <input type="date" class="form-control w-75" aria-label="Sizing example input"
                   aria-describedby="inputGroup-sizing-sm" name="birth_day" value="<?php echo e($staff->birth_day); ?>">
        </div>
        <div class="w-100 input-group input-group-sm mb-3">
            <div class="w-25 input-group-prepend">
            ...
            <select class="form-control" name="gender">
                <?php $__currentLoopData = \App\Enums\User\UserGender::asArray(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $gender): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option <?php echo e($staff->gender == $gender ? 'selected' : ''); ?> value=<?php echo e($gender); ?>>
...
<?php echo $__env->make('admin.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\DATN\VVCBooking\resources\views/admin/pages/staffs/edit.blade.php ENDPATH**/ ?>
