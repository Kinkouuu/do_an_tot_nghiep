...
} elseif ($_instance->childHasBeenRendered('6TzSvVb')) {
    $componentId = $_instance->getRenderedChildComponentId('6TzSvVb');
    $componentTag = $_instance->getRenderedChildComponentTagName('6TzSvVb');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('6TzSvVb');
} else {
    $response = \Livewire\Livewire::mount('verify.re-send-code', []);
    $html = $response->html();
    $_instance->logRenderedChild('6TzSvVb', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php /**PATH E:\DATN\VVCBooking\resources\views/user/pages/verify-code.blade.php ENDPATH**/ ?>
